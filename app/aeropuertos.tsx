  ...
  return (
    ...
    >
      <View>
        ...
        <Text style={[styles.title, { color: colors.foreground }]}>LAD</Text>
        <Text style={[styles.sub, { color: colors.mutedForeground }]}>
          {aerodromos.length} aeródromos registrados. Tocá uno para navegar.
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  clearBtn: { padding: 4 },
  row: { flexDirection: "row", alignItems: "center", padding: 14, borderWidth: 1, gap: 14 },
  rowLeft: { flex: 1, gap: 3 },
  icao: { fontFamily: "Inter_700Bold", fontSize: 13, letterSpacing: 1 },
  ...
  empty: { fontFamily: "Inter_400Regular", fontSize: 13, textAlign: "center", marginTop: 24 },
  toggleRow: { paddingHorizontal: 14, borderWidth: 1, justifyContent: "center" },
  toggleBtn: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 12 },
  toggleText: { fontFamily: "Inter_500Medium", fontSize: 13 },
  label: { fontFamily: "Inter_600SemiBold", fontSize: 11, letterSpacing: 1.8 },
});
